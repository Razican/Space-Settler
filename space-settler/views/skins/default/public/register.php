<div id="main">
		<div id="mainmenu" style="margin-top: 20px;">
			...
			<?php echo anchor(config_item('forum_url'), lang('overal.forum'), 'target="_blank"'); ?>
		</div>
		...
		<div id="title"><?php echo lang('login.reg_message').' '.config_item('game_name'); ?></div>
			<div id="content">
				<div id="text1">
					<div style="text-align: justify;"><?php echo config_item('long_descr'); ?></div>
				</div>
				<input type="submit" value="<?php echo lang('login.server_register'); ?>" name="submit" id="register_input" class="bigbutton" />
				<div id="text2">
					<div id="text3">
						<strong><?php echo lang('login.server_message').' '.config_item('game_name'); ?>!</strong>
					</div>
