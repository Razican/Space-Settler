<div id="menu">
<ul>
	<li><?php echo anchor('/', lang('menu.overview')); ?></li>
	<li><?php echo anchor('#', lang('menu.galaxy')); ?></li>
	<li><?php echo anchor('#', lang('menu.explore')); ?></li>
	...
	<li><?php echo anchor('#', lang('menu.support')); ?></li>
