...
<div id="content">
	...
	<?php echo form_open('register'); ?>
		...
		<div><label for="form_email"><?php echo lang('login.email'); ?></label>: <input title="<?php echo lang('login.email'); ?>" id="form_email" name="email" size="20" maxlength="20" value="" type="text" /></div>
